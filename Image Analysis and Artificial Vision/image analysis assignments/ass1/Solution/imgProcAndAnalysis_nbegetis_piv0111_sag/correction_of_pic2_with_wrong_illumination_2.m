...
% We assume a real array 'van' where we place the I64 array
van = I64;
...
% in a new bmp file 
I64_final_picture_2=ivan_real; 

figure;
imshow(I64_final_picture_2);
imwrite(I64_final_picture_2,'picture_2_cleared.bmp'); % write in bmp file
