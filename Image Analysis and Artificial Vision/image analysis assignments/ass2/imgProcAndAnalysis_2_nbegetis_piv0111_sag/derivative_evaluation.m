...
I8=imread('./Images/AIRPORT.tif');% Be caruful the file  AIRPORT.tif to be in working 
...
imwrite(Gx,'./Output_images/AIRPORT_x-der.tif');%The image is written in th workin directory. 
%                                Give full path if you wish image to be written in another directory.
imwrite(Gy,'./Output_images/AIRPORT_y-der.tif');
imwrite(Gxy,'./Output_images/AIRPORT_xy-der.tif');
