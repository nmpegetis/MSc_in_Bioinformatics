...
%% calculates the mean value and the standared deviation by using our 
%% own functions and then by verifying them with the matlab's respective 
%% functions.
%% Filename: RoiConstruction.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


function []=RoiConstruction()
